    ...
    return (
      <DefaultLayout title='Home' description='the Home description'>
        <div>
          ...
          <p>Mollit dicta. Do nesciunt non molestiae error elit. Cillum voluptas and eaque irure elit, perspiciatis error. Enim aperiam voluptatem nor iure for autem. Eu amet for aliquam and doloremque consequatur irure. Cupidatat magna but aliquam quasi eum yet si nor ipsum. Exercitationem lorem yet eu excepteur fugit accusantium and voluptatem. Accusantium sit for aliquid or doloremque quasi but reprehenderit.</p>
        </div>
      </DefaultLayout>
    )
  }
